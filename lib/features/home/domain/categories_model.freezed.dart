...
abstract class $CategoriesModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String name, String image, int order});
}
...
class _$CategoriesModelImpl implements _CategoriesModel {
  ...
  @override
  String toString() {
    return 'CategoriesModel(id: $id, name: $name, image: $image, order: $order)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, image, order);
